# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-08-01 10:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aParent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cart.AreaInfo')),
            ],
            options={
                'db_table': 'areainfo',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra', models.CharField(blank=True, max_length=20, null=True)),
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.Goods')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.Goods')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.UserInfo'),
        ),
        migrations.AddField(
            model_name='orders',
            name='userOrder',
        ...
        migrations.AddField(
            model_name='goods',
            name='goodSort',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.GoodSort'),
        ),
        migrations.AddField(
            model_name='cart',
            name='userCart',
